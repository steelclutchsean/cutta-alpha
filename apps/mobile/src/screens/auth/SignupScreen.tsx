      ...
      >
        <ScrollView contentContainerStyle={styles.content}>
          ...
          <Animated.View entering={FadeInDown.delay(300)} style={styles.titleContainer}>
            ...
            <Text style={styles.subtitle}>Join thousands of Calcutta enthusiasts</Text>
          </Animated.View>

          {/* Form */}
          <Animated.View entering={FadeInDown.delay(400)} style={styles.form}>
            <View style={styles.inputContainer}>
              <Ionicons name="person-outline" size={20} color={colors.dark[400]} style={styles.inputIcon} />
              <TextInput
                style={styles.input}
